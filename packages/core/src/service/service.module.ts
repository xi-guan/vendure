...
import { PrismaOrmModule } from './prisma-orm.module';
 ...
 */
@Module({
    imports: [ConnectionModule, ConfigModule, EventBusModule, CacheModule, JobQueueModule, SchedulerModule, PrismaOrmModule],
